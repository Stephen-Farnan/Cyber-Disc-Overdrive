...
public class MouseShooting : MonoBehaviour
{
    ...
    /// <summary>
    /// Checks if the player can fire and throws out the disc forward
    /// </summary>
    void FireProjectile()
    {
        canFire = false;
    ...
    /// <summary>
    /// increases the speed as the disc combo goes up
    /// </summary>
    /// <returns></returns>
    ...
    /// <summary>
    /// Sets the angle the disc will be parried to
    /// </summary>
    /// <returns></returns>
    ...
    /// <summary>
    /// Holds the parry input for a short peroid of time to make parrying easier for the user
    /// </summary>
    /// <returns></returns>
    ...
    /// <summary>
    /// Provides feedback on a successful parry and increases the combo count
    /// </summary>
    ...
    /// <summary>
    /// Pulls the disc back to the player object and resets the combo count and speed
    /// </summary>
    /// <returns></returns>
